...
db_config = DMysqlConfig(MYSQL_HOST, MYSQL_DBNAME, MYSQL_USER, MYSQL_PASSWORD, MYSQL_PORT)
...
def check_it():
    ...
    with UsingMysql(log_time=True) as um:
        um.cursor.execute("select count(id) as ct from t_shop_mock")
        data = um.cursor.fetchone()
        print("-- 当前数量: %d " % data['ct'])
