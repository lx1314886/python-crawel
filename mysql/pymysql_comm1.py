...
db_config1 = DMysqlConfig1(MYSQL_HOST, MYSQL_DBNAME1, MYSQL_USER, MYSQL_PASSWORD, MYSQL_PORT)


g_pool_connection1 = DMysqlPoolConn1(db_config1)

class UsingMysql1(object):
    ...
    def __enter__(self):
        ...
        # 在进入的时候自动获取连接和cursor
        conn = g_pool_connection1.get_conn()
    ...
    def update_batch_by_pk(self, sql, params=None):
